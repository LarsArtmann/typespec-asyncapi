...
export const comparisonRows: ComparisonRow[] = [
  {
    feature: "AsyncAPI version",
    emitter: "3.1.0 (latest)",
    tspAsyncapi: "3.0.0",
    handwritten: "any",
  },
  {
    feature: "Output validation",
    emitter: "270+ AJV compliance tests",
    tspAsyncapi: "15 property tests",
    handwritten: "Spectral, at best",
  },
  {
    feature: "Protocols",
    emitter: "22, bindings spec-generated",
    tspAsyncapi: "13, hand-written",
    handwritten: "manual per protocol",
  },
  {
    feature: "Reusable components",
    emitter: "7 slots, 11 decorators",
    tspAsyncapi: "not supported",
    handwritten: "copy-paste",
  },
  {
    feature: "Multi-file output",
    emitter: "split-schemas + $ref rewrite",
    tspAsyncapi: "not supported",
    handwritten: "manual",
  },
  {
    ...
    emitter: "30 codes",
    tspAsyncapi: "deferred",
    handwritten: "lint only",
  },
  {
    feature: "Typed source of truth",
    emitter: "TypeSpec",
    tspAsyncapi: "TypeSpec",
    handwritten: "none",
  },
];
