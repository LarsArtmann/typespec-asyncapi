# TypeSpec AsyncAPI Emitter — Typed AsyncAPI 3.1 Specs from TypeSpec
...
| `extracted/tokens.json`           | Design tokens: 16 colors, 1 fonts, 20 headings, 0 CTAs                                                                                                     |
...
- **Colors**: #A8A29E (neutral), #0A0908 (bg-dark), #14B8A6 (accent), #E7E5E4 (surface-light), #1C1917 (surface-dark), #8E8884 (neutral), #292524 (surface-dark), #14B1A7 (accent), #110E0C (surface-dark), #44403C (neutral)
