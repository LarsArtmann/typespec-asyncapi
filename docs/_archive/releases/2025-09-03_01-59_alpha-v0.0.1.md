...
# Or with npm
bun add @lars-artmann/typespec-asyncapi @typespec/compiler
```
...
_This Alpha represents the foundation for enterprise-grade AsyncAPI generation from TypeSpec. While limited in scope, it demonstrates the core value proposition and establishes the architecture for future enhancements._
