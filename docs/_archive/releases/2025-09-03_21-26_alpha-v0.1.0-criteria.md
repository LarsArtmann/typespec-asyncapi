...
- [ ] **TypeSpec Compilation Works** - `pnpm dlx tsp compile example.tsp --emit @larsartmann/typespec-asyncapi` succeeds
...
- [ ] **Package Exports Correct** - Can be installed and imported as pnpm package
...
pnpm dlx tsp compile test-alpha.tsp --emit @larsartmann/typespec-asyncapi

# 5. Validate AsyncAPI output
pnpm dlx @asyncapi/parser validate tsp-output/@larsartmann/typespec-asyncapi/asyncapi.yaml
```
...
4. Package can be installed via pnpm/bun
