...
graph TD
    ...
    Phase1[Phase 1: Critical Survival<br/>45 min → 51% Impact]
    Phase1 --> CS1[Fix @effect/schema Types]
    CS1 --> CS2[Restore Build Stability]
    CS2 --> CS3[Recover Core Tests]
    CS3 --> Success1[✅ Build Passes<br/>✅ Foundation Stable]

    Success1 --> Phase2[Phase 2: Tactical Recovery<br/>165 min → 64% Impact]
    Phase2 --> TR1[Abort @effect/schema]
    TR1 --> TR2[Implement Zod Validation]
    TR2 --> TR3[Fix Core Decorators]
    TR3 --> TR4[Stabilize Tests]
    TR4 --> Success2[✅ 80% Tests Passing<br/>✅ Development Velocity]

    Success2 --> Phase3[Phase 3: Strategic Excellence<br/>495 min → 80% Impact]
    ...
    SE5 --> Success3[✅ Production Ready<br/>✅ Complete AsyncAPI 3.0]
