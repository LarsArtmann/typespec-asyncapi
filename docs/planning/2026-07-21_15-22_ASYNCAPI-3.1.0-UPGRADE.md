...
**No dependency change is needed.** No pnpm install. No lockfile change. No malware exposure. This is a pure code change.
...
- pnpm `latest` tag was rolled back to 6.11.1; no patched successor exists
