...
**Goal:** Ship v0.3.0 so that `@lars-artmann/typespec-asyncapi` is *installable, provably deeper, and feature-parity* on every axis a user can compare against [`tsp-asyncapi`](https://github.com/marvin-hsu/tsp-asyncapi) (npm, v0.2.1, ~426 dl/month, created 2026-08-11).
