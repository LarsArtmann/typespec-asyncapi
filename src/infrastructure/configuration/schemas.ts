 ...
 */
const PROTOCOL_SCHEMA = Schema.Literal(
  "kafka",
  "amqp",
  "mqtt",
  "nats",
...
const OPTIONAL_RECORD_SCHEMA = Schema.optional(
  Schema.Record({
    key: Schema.String,
...
const OPERATION_SCHEMA = Schema.Struct({
  ...
  messages: Schema.optional(
    Schema.Record({
      key: Schema.String,
      value: Schema.Union(Schema.Literal(null), MESSAGE_SCHEMA, REF_SCHEMA),
    }),
  ),
});
...
export const ASYNCAPI_DOCUMENT_SCHEMA = Schema.Struct({
  ...
  servers: Schema.optional(
    Schema.Record({ key: Schema.String, value: SERVER_SCHEMA }),
  ),
  channels: Schema.optional(
    Schema.Record({ key: Schema.String, value: CHANNEL_SCHEMA }),
  ),
  operations: Schema.optional(
    Schema.Record({ key: Schema.String, value: OPERATION_SCHEMA }),
  ),
 ...
 */
export const decodeAsyncAPIDocument = Schema.decodeUnknown(
  ASYNCAPI_DOCUMENT_SCHEMA,
);
...
const variableConfigSchema = Schema.Struct({
  description: Schema.optional(
    Schema.String.pipe(
      ...
      Schema.annotations({
        description: "Variable description (max 500 chars)",
      }),
    ),
  ),
...
const oAuthFlowConfigSchema = Schema.Struct({
  ...
  availableScopes: Schema.optional(
    Schema.Record({
      key: Schema.String.pipe(
        Schema.pattern(/^[a-zA-Z0-9._:-]+$/, {
          message: () =>
            "Scope name must contain only alphanumeric, dot, underscore, colon, or hyphen characters",
        }),
        Schema.maxLength(100),
      ),
  ...
  Schema.annotations({
    ...
    description:
      "OAuth flow configuration with URL validation and scope limits",
  }),
);
...
const securitySchemeConfigSchema = Schema.Struct({
  type: Schema.Literal(
    ...
    Schema.annotations({
      description: "Security scheme type - determines available fields",
    }),
  ),
  description: Schema.optional(
    Schema.String.pipe(
      ...
      Schema.annotations({
        description: "Human-readable security scheme description",
      }),
    ),
  ),
  name: Schema.optional(
    Schema.String.pipe(
      Schema.pattern(/^[a-zA-Z0-9._-]+$/, {
        message: () =>
          "Security scheme name must contain only alphanumeric, dot, underscore, or hyphen characters",
      }),
      Schema.maxLength(50),
      Schema.annotations({
        description: "Security parameter name (for apiKey schemes)",
      }),
    ),
  ),
  in: Schema.optional(
    Schema.Literal("user", "password", "query", "header", "cookie").pipe(
  ...
  scheme: Schema.optional(
    Schema.String.pipe(
      ...
      Schema.maxLength(20),
      Schema.annotations({
        description: "HTTP authentication scheme (for http type)",
      }),
    ),
  ),
  bearerFormat: Schema.optional(
    Schema.String.pipe(
      Schema.maxLength(50),
      Schema.annotations({
...
const versioningConfigSchema = Schema.Struct({
  ...
  "file-naming": Schema.optional(
    Schema.Literal("suffix", "directory", "prefix"),
  ),
  "include-version-info": Schema.optional(Schema.Boolean),
  "version-mappings": Schema.optional(
    Schema.Record({
      key: Schema.String,
      value: Schema.String,
    }),
    ...
    Schema.Struct({
      "output-file": Schema.optional(
        Schema.String.pipe(
          ...
          description:
            "Name of the output file. Supports template variables: {cmd}, {project-root}, {emitter-name}, {output-dir}. Default: 'asyncapi.yaml'",
          jsonSchema: { type: "string", description: "Output file name" },
        }),
      ),

      "file-type": Schema.optional(
        Schema.Literal("yaml", "json").annotations({
          description: "Output file type. Default: 'yaml'",
        }),
      ),

      "asyncapi-version": Schema.optional(
        Schema.Literal("3.0.0").annotations({
          description: "AsyncAPI version to target. Default: '3.0.0'",
        }),
      ),

      "omit-unreachable-types": Schema.optional(
        Schema.Boolean.annotations({
          description:
            "Whether to omit unreachable message types. Default: false",
        }),
      ),

      "include-source-info": Schema.optional(
        Schema.Boolean.annotations({
          description:
            "Whether to include TypeSpec source information in comments. Default: false",
        }),
      ),

      "default-servers": Schema.optional(
        Schema.Record({
          key: Schema.String,
      ...
      "validate-spec": Schema.optional(
        Schema.Boolean.annotations({
          description:
            "Whether to validate generated AsyncAPI spec. Default: true",
        }),
      ),

      "additional-properties": Schema.optional(
        Schema.Record({
          key: Schema.String,
          value: Schema.Unknown,
        }).annotations({
      ...
      "protocol-bindings": Schema.optional(
        Schema.Array(
      ...
      "security-schemes": Schema.optional(
        Schema.Record({
          key: Schema.String,
      ...
      versioning: Schema.optional(
        versioningConfigSchema.annotations({
      ...
      Schema.annotations({
        ...
        description:
          "Complete AsyncAPI emitter configuration options with validation",
        documentation:
          "https://github.com/typespec/asyncapi-emitter/docs/options",
      }),
    ),
);
