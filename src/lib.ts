...
export const $lib = createTypeSpecLibrary({
  ...
  state: {
    ...
    operationReplies: { description: "Operations to reply data" },
    operationIds: { description: "Operations to custom IDs" },
...
export const stateSymbols = {
  ...
  operationReplies: Symbol("operationReplies"),
  operationIds: Symbol("operationIds"),
  ...
  operationTraits: Symbol("operationTraits"),
  messageTraits: Symbol("messageTraits"),
  reusableParameters: Symbol("reusableParameters"),
  reusableCorrelationIds: Symbol("reusableCorrelationIds"),
  reusableBindings: Symbol("reusableBindings"),
  operationTraitRefs: Symbol("operationTraitRefs"),
