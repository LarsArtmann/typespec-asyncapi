...
export const dieWith = (message: string, context?: Record<string, unknown>) =>
...
export const Railway = {
  ...
  fromError: (error: Error, context?: Record<string, unknown>) => createError({
    ...
    escape: "Check your input and try with simpler data",
    severity: "error" as const,
   ...
   */
  all: <T extends readonly Effect.Effect<any, StandardizedError>[]>(effects: T) =>
    Effect.all(effects),
