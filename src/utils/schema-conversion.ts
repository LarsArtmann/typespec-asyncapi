 ...
 */
export function getPropertyType(prop: ModelProperty): { type: "string" | "number" | "boolean" | "object" | "array" | "null" | "integer", format?: string } {
  ...
  else if (prop.type.kind === "Model" && (prop.type as Model).name === "utcDateTime") {
    propType = "string";
    format = "date-time";
  }
