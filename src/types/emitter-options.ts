/**
 * Type definitions for AsyncAPI Emitter Options
 *
 * Consolidated type definitions for all AsyncAPI emitter configuration options.
 * Extracted from src/options.ts to improve modularity and maintainability.
 */
...
export type AsyncAPIEmitterOptions = {
	 ...
	 * @default "yaml"
	 */
	"file-type"?: "yaml" | "json" = "yaml";

	/**
	 * AsyncAPI version to target
	 * @default "3.0.0"
	 */
	"asyncapi-version"?: "3.0.0" = "3.0.0";
