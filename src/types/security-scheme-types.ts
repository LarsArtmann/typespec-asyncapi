 ...
 */
const isSchemeWithNameAndIn = (
  scheme: unknown,
  expectedType: string,
): scheme is Record<string, unknown> & { name: string; in: string } => {
...
export const isHttpApiKeyScheme = (
  scheme: unknown,
): scheme is HttpApiKeyScheme => {
...
export const isOpenIdConnectScheme = (
  scheme: unknown,
): scheme is OpenIdConnectScheme => {
...
export const isUserPasswordScheme = (
  scheme: unknown,
): scheme is UserPasswordScheme => {
...
export const isSymmetricEncryptionScheme = (
  scheme: unknown,
): scheme is SymmetricEncryptionScheme => {
  return hasType(scheme, "symmetricEncryption");
};

export const isAsymmetricEncryptionScheme = (
  scheme: unknown,
): scheme is AsymmetricEncryptionScheme => {
