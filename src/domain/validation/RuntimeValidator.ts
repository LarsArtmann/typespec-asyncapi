...
export const CHANNEL_OBJECT_SCHEMA: Schema.Schema<ChannelObject> =
  Schema.Struct({
    name: Schema.String.pipe(Schema.minLength(1)),
  });

export const OPERATION_OBJECT_SCHEMA: Schema.Schema<OperationObject> =
  Schema.Struct({});
export const MESSAGE_OBJECT_SCHEMA: Schema.Schema<MessageObject> =
  Schema.Struct({});
export const SCHEMA_OBJECT_SCHEMA: Schema.Schema<SchemaObject> = Schema.Struct(
  {},
);
export const SECURITY_SCHEME_OBJECT_SCHEMA: Schema.Schema<SecuritySchemeObject> =
  Schema.Struct({
