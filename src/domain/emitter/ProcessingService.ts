...
export const orchestrateAsyncAPITransformation = (
	...
	Effect.gen(function* () {
		yield* Effect.log("🚀 Orchestrating complete TypeSpec to AsyncAPI transformation...")
		...
		const totalProcessed = operationsProcessed + messagesProcessed + securityProcessed
