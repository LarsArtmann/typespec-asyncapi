 ...
 * ```
 */
export class StateMapMissingError extends Data.TaggedError(
...
export const createStateMapMissingError = (details?: { program?: unknown }) =>
  new StateMapMissingError({
    message:
      "AsyncAPI Emitter Error: Program missing stateMap method. This is required for TypeSpec decorator state management. Ensure the TypeSpec compiler version is compatible and program initialization is complete.",
