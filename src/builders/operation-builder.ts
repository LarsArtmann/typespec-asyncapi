...
import { escapeRefToken, ref, refChannel } from "../domain/models/asyncapi-document.js";
...
export function buildOperations(state: AsyncAPIConsolidatedState, ctx: DocumentBuildContext): void {
