      ...
      const documents = [
        {
          ...
          document: {
            ...
            operations: {
              op1: { action: "send", channel: { $ref: "#/channels/ch1" } },
            },
          },
        },
        {
          ...
          document: {
            ...
            operations: {
              op2: { action: "receive", channel: { $ref: "#/channels/ch2" } },
            },
          },
        },
        {
    ...
    it("should cache validation results for better performance", async () => {
      const document = {
        ...
        operations: {
          cacheOp: {
            action: "send",
            channel: { $ref: "#/channels/cache-channel" },
          },
        },
      };
...
describe("Convenience Functions", () => {
  it("should validate document using convenience function", async () => {
    const document = {
      ...
      operations: {
        testOp: { action: "send", channel: { $ref: "#/channels/test" } },
      },
    };
  ...
  it("should validate file using convenience function", async () => {
    const validDocument = {
      ...
      operations: {
        fileOp: { action: "send", channel: { $ref: "#/channels/file-test" } },
      },
    };
