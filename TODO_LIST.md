...
- [ ] **`@service` decorator diagnostic:** `@service({})` is not registered and silently kills output. Needs either a no-op registration or a diagnostic warning for OpenAPI-to-AsyncAPI migrants.
